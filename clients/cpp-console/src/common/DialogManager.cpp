...
\"membersRemoved\":null,\"reactionsAdded\":null,\"reactionsRemoved\":null,\"topicName\":null,\
\"historyDisclosed\":null,\"locale\":null,\"text\":\"" + user_text + "\",\"speak\":null,\"inputHint\":null,\
\"summary\":null,\"suggestedActions\":null,\"attachments\":[],\"entities\":[],\"channelData\":null,\
\"action\":null,\"replyToId\":null,\"label\":null,\"valueType\":null,\"value\":null,\"name\":null,\
\"relatesTo\":null,\"code\":null,\"expiration\":null,\"importance\":null,\"deliveryMode\":null,\
\"listenFor\":null,\"textHighlights\":null,\"semanticAction\":null,\"callerId\":null}";
	auto stringFuture = _dialogServiceConnector->SendActivityAsync(to_send);
}
